    ...
    return (
        <article className="h-full">
            ...
            >
                ...
                <CardContent className="flex flex-1 flex-col gap-0 pt-4 relative">
                    ...
                    <div className=" flex flex-wrap gap-1.5 py-3">
                        ...
                        <div className=" absolute bottom-0 right-4 flex items-center justify-end gap-1 text-muted-foreground py-1">
                            <Package className="size-3 shrink-0" aria-hidden />
                            <span className="tabular-nums text-xs">
                                {creator.completedOrders} orders
                            </span>
                        </div>
                </CardContent>
