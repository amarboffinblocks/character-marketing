...
const multiSelectVariants = cva("m-1 transition-all duration-300 ease-in-out", {
	variants: {
		variant: {
			default: "border-border bg-accent/70 text-foreground hover:bg-accent",
			secondary:
				...
				<Popover
					...
					<PopoverTrigger
						render={
							...
							className={cn(
								"flex min-h-10 h-auto items-center justify-between rounded-md border border-border bg-background p-1 text-foreground shadow-xs hover:bg-accent/40 [&_svg]:pointer-events-auto",
								...
								<div className="flex justify-between items-center w-full">
									<div
										...
										{selectedValues.length > responsiveSettings.maxCount && (
											<Badge
												className={cn(
													"border-border bg-muted text-foreground hover:bg-muted/90",
													getBadgeAnimationClass(),
													multiSelectVariants({ variant }),
													responsiveSettings.compactMode &&
														"text-xs px-1.5 py-0.5",
									...
									<div className="flex items-center justify-between">
										<div
											...
											className="mx-2 flex h-4 w-4 cursor-pointer items-center justify-center rounded-sm text-muted-foreground hover:bg-muted hover:text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1">
										...
										/>
										<ChevronDown
											className="mx-2 h-4 cursor-pointer text-muted-foreground group-hover:text-foreground"
											aria-hidden="true"
										/>
									</div>
								</div>
											...
											<div
												className={cn(
													...
													selectedValues.length ===
														...
														: " text-muted-foreground [&_svg]:invisible"
												)}
												aria-hidden="true">
													...
													<CommandItem
														...
														<div
															className={cn(
																...
																isSelected
																	? "border-primary bg-primary text-primary-foreground"
																	: "bg-background text-muted-foreground [&_svg]:invisible"
															)}
															aria-hidden="true">
															<CheckIcon className="h-4 w-4" />
														</div>
										...
										{filteredOptions.map((option) => {
											...
											return (
												<CommandItem
													...
													className={cn(
														"cursor-pointer data-[selected=true]:bg-accent data-[selected=false]:bg-transparent  data-[selected=true]:text-accent-foreground",
														option.disabled && "opacity-50 cursor-not-allowed"
													)}
													disabled={option.disabled}>
													<div
