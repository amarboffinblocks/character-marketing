...
export function CustomPackageRequestForm({
  ...
  const activeItemIndex = activeItemIndexByStep[currentStepId]
  ...
  useEffect(() => {
    const currentActiveIndex = activeItemIndexByStep[currentStepId]
    if (currentActiveIndex === null) {
      return
    }

    if (currentActiveIndex >= currentStep.array.fields.length) {
